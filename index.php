...
<main>
        ...
        <h1 class="py-4 bg-danger text-light rounded text-center"><i class="fas fa-tasks"></i> To Do List </h1>
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                ...
                <div class="pt-2">
                    <?php inputElement("<i class='fas fa-book'></i>","Subject Name", "task_name",""); ?>
                </div>
                <div class="pt-2">
